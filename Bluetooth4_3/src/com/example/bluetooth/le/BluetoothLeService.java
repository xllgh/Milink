...
public class BluetoothLeService extends Service {
	...
	public final static String ACTION_RSSI_AVAILABLE = "com.example.bluetooth.le.RSSI_DATA_AVAILABLE";
...
//				broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
			...
			Log.v("BLETest","onCharacteristicChanged");
		}
	...
	//rssi广播
	private void broadcastUpdate(final String action, final int mRssi){
		final Intent intent = new Intent(action);
		intent.putExtra("111", mRssi);
		sendBroadcast(intent);
	}
