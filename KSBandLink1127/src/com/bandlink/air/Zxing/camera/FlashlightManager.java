...
final class FlashlightManager {
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      MyLog.w(TAG, "Unexpected error while finding method " + name, re);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      ...
      MyLog.w(TAG, "Unexpected error while invoking " + method, e.getCause());
      return null;
    } catch (RuntimeException re) {
      MyLog.w(TAG, "Unexpected error while invoking " + method, re);
      return null;
    }
  }
