package com.bandlink.air.Zxing.camera;
...
public class FlashlightManager1 {  
    private static final String TAG = FlashlightManager1.class.getSimpleName();  
    ...
    private static Class<?> maybeForName(String name) {  
        try {  
            ...
            re.printStackTrace();  
            MyLog.w(TAG, "Unexpected error while finding class " + name, re);  
            return null;  
        }  
    }  
    /** 
    ...
    List<String> flashModes = parameters.getSupportedFlashModes();  
        ...
        MyLog.i(TAG, "Flash mode: " + flashMode);  
        MyLog.i(TAG, "Flash modes: " + flashModes);  
    ...
    public static void turnLightOff(Camera mCamera) {  
        ...
        if (!Parameters.FLASH_MODE_OFF.equals(flashMode)) {  
            ...
            if (flashModes.contains(Parameters.FLASH_MODE_OFF)) {  
                ...
                MyLog.e(TAG, "FLASH_MODE_OFF not supported");  
            }  
        }  
    }  
    ...
    private static Object invoke(Method method, Object instance, Object... args) {  
        try {  
            ...
            MyLog.w(TAG, "Unexpected error while invoking " + method, e);  
            return null;  
        }  
    }  
    /** 
