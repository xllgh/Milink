...
//  private static final int MIN_FRAME_WIDTH = 240;
  ...
  private static final int MAX_FRAME_HEIGHT = 1900;
...
//      }
      FlashlightManager.enableFlashlight();
      //FlashlightManager1.turnLightOn(camera);
    }
  }
  ...
  public void requestAutoFocus(Handler handler, int message) {
    if (camera != null && previewing) {
      ...
      //MyLog.d(TAG, "Requesting auto-focus callback");
  ...
  public Rect getFramingRect() {
    ...
    if (framingRect == null) {
      ...
      MyLog.d(TAG, "Calculated framing rect: " + framingRect);
    }
    return framingRect;
  }
