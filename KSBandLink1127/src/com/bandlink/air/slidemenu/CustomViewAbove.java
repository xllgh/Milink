package com.bandlink.air.slidemenu;

import java.util.ArrayList;
import java.util.List;

import com.bandlink.air.MyLog;
import com.bandlink.air.slidemenu.SlidingMenu.OnClosedListener;
import com.bandlink.air.slidemenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private boolean thisSlideAllowed(float dx) {
		...
		if (DEBUG)
			MyLog.v(TAG, "this slide allowed " + allowed + " dx: " + dx);
		return allowed;
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (DEBUG)
			if (action == MotionEvent.ACTION_DOWN)
				MyLog.v(TAG, "Received ACTION_DOWN");
	...
	private void onSecondaryPointerUp(MotionEvent ev) {
		if (DEBUG) MyLog.v(TAG, "onSecondaryPointerUp called");
