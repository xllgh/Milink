...
public class MiSpeechSummary {
	...
	public MiSpeechSummary(Context context,int steps, int durance, int distance, int calorie) {
		cc=context;
		msteps=steps;
		mdurance=durance;
		mdistance=distance;
        ...
        soundMap1.put("step", soundPool.load(context, R.raw.step, 1));
        soundMap1.put("workout_distance", soundPool.load(context, R.raw.workout_distance, 1));
        soundMap1.put("meter", soundPool.load(context, R.raw.meter, 1));
        soundMap1.put("workout_time", soundPool.load(context, R.raw.workout_time, 1));
        ...
        soundMap1.put("youve_burned", soundPool.load(context, R.raw.youve_burned, 1));
        soundMap1.put("calorie", soundPool.load(context, R.raw.calorie, 1));
	...
	public void play() throws InterruptedException
	{
		...
		Thread.sleep(1200);
		play1(msteps);
		soundPool.play(soundMap1.get("step"), 1, 1, 0, 0, 1);
		Thread.sleep(dd1+500);
		
		soundPool.play(soundMap1.get("workout_distance"), 1, 1, 0, 0, 1);
		Thread.sleep(800);
		play1(mdistance);
		soundPool.play(soundMap1.get("meter"), 1, 1, 0, 0, 1);
		Thread.sleep(dd1+500);

		soundPool.play(soundMap1.get("workout_time"), 1, 1, 0, 0, 1);
		Thread.sleep(1200);
		...
		soundPool.play(soundMap1.get("youve_burned"), 1, 1, 0, 0, 1);
		Thread.sleep(1200);
		play1(mcalorie);
		soundPool.play(soundMap1.get("calorie"), 1, 1, 0, 0, 1);
		Thread.sleep(dd1);
