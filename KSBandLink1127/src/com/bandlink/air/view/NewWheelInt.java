...
public class NewWheelInt extends View {
	...
	public NewWheelInt(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		for (int i = 0; drawCount <= 4 * width; i++) {
			...
			if (xPosition + getPaddingRight() < mWidth) {
				if ((mValue + i) % mModType == 0) {
					canvas.drawLine(xPosition, getPaddingTop(), xPosition, mDensity * (int)(ITEM_MAX_HEIGHT*0.6), linePaint);
