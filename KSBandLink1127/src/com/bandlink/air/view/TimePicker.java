...
import com.bandlink.air.view.NumberPicker.OnValueChangeListener;
...
public class TimePicker extends FrameLayout implements OnClickListener {
	...
	public TimePicker(Context context, AttributeSet attrs) {
		...
		hourPicker.setOnValueChangedListener(new OnValueChangeListener() {
			...
			public void onValueChange(NumberPicker picker, int oldVal,
				...
				if(ontime!=null){
					ontime.onTimeChanged(newVal, minPicker.getValue());
				}
			}
		});
	...
	OnTimeChanged ontime;
	public void setOnTimeChanged(OnTimeChanged on){
		ontime =on;
	}
